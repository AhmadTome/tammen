...
@section('title','ادخال قطع هيكل')

@section('content')

<div class="panel panel-default">
            <div class="panel-heading text-center PanelHeadingCss">ادخال قطع هيكل</div>
            <div class="panel-body PanelBodyCss">

                <div class="container " style="max-width: 1000px ;margin-bottom: -15px">
                    <form class="form-horizontal" method="post" action="storeBodyParts" >
                        {{ csrf_field() }}
                        <div class="form-group">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-9">
                                <input type="number" class="form-control PanelBodyCssInput" name="idBodyNum" id="idBodyNum" placeholder="ادخل رقم القطعة" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-9">
                                <input type="text" class="form-control PanelBodyCssInput" name="hebrow_Bodyname" id="hebrow_Bodyname" placeholder="ادخل الاسم عبري" required >
                            </div>
