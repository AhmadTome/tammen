...
@section('title','إدخال نص تركيب')

@section('content')

<div class="panel panel-default">
            <div class="panel-heading text-center PanelHeadingCss">ادخال نص تركيب</div>
            <div class="panel-body PanelBodyCss">

                <div class="container " style="max-width: 1000px ;margin-bottom: -15px">
                    <form class="form-horizontal" method="post" action="storeTextStructure">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-9">
                                <input type="address" class="form-control PanelBodyCssInput" name="textName" id="textName" placeholder="ادخل نص التركيب" required>
                            </div>
