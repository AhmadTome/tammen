<div class="BodyDiv col-lg-12 col-md-12 col-xs-12 col-sm-12 pull-left" >
    <div class="container">
        @if(session()->has('notif_mech'))

            <div class="row">
                <div class="alert alert-success" dir="rtl">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <strong>{{ session('notif_mech') }}</strong>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body PanelBodyCss">
            ...
            <div>
                ...
                <form class="form-group" method="post" action="storeMechanicwork" id="mechanicalform">
                {{ csrf_field() }}
...
$(document).ready(function () {
    ...
    $("#mechanicalform").on("submit",function () {
        if($("#filenumber").val() == ""){
