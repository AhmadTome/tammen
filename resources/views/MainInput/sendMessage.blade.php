...
<div class="container-fluid">
    ...
    <div class="BodyDiv col-lg-12 col-md-12 col-xs-12 col-sm-12 " >
        <div class="panel panel-default">
            <div class="panel-heading text-center PanelHeadingCss">ارسال ايميل</div>
...
<form action="sendmail" method="post">
    ...
    <div class="form-group col-sm-12 row" dir="rtl">
        <label class="control-label col-sm-2 pull-right text-left">ايميل المستقبل :</label>
        <div class="col-sm-5 pull-right text-left">
            <input class="form-control" type="email" name="mail" placeholder="ادخل الايميل" required>
        </div>
    </div>
