...
<div class="container-fluid">
    ...
    <div class="BodyDiv col-lg-12 col-md-12 col-xs-12 col-sm-12 pull-left" >
        ...
        <div class="panel panel-default">
            <div class="panel-heading text-center PanelHeadingCss">تعديل واستعلام غيار ميكانيك</div>
            <div class="panel-body PanelBodyCss">
                ...
                <div >
                    ...
                    <form class="form-group" method="post" action="Editmechanicalwork" id="editmechinicalworkform">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row" dir="rtl">
                            ...
                            <div class="col-sm-8 pull-right">
                                <textArea type="Bodynote" class="form-control PanelBodyCssInput _details" rows="5" id="noteMech" placeholder="ادخل ملاحظات"></textArea>
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" >
                                        ...
                                        <div class="deleteContent" dir="rtl">
                                            هل أنت متأكد من أنك تريد حذف قطع غيار ميكانيك للمركبة الخاصة بملف  <span class="dname"></span> ؟
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#editmechinicalworkform").on("submit",function () {
            if($("#filenumber").val() == ""){
        ...
        $('.modal-footer').on('click', '.delete', function() {
            ...
            $.ajax({
                type: 'get',
                url: '{!!URL::to('deletemechanicalwork')!!}',
                data: {
                    'id':ID
                },
        ...
        $(document).on("change",".carInfo_select",function () {
            ...
            $.ajax({
                ...
                type:'get',
                url:'{!!URL::to('getallmechanicaldata')!!}',
                data:{'id':file_nom},
                success:function(data) {
                    ...
                    if(data.data2.length > 0){
                        ...
                        var table=document.getElementsByTagName("table")[0];
                        var count = $('#MechanicTable tr').length;
                        for(var k=0;k<count-1;k++)
                            document.getElementById("MechanicTable").deleteRow(1);
                        ...
                        for(var g=0;g<data.data2.length;g++){
                            ...
                            cell1.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][carnumber]" value="' + data.data2[g].me_vehicle_num + '" />'+data.data2[g].me_vehicle_num+'</td>' ;
                            cellfile.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][fileNumber]" value="' + data.data2[g].filenumber + '" />'+data.data2[g].filenumber+'</td>' ;
                            cell2.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][limitno]" value="' + data.data2[g].me_limit_num + '" />'+data.data2[g].me_limit_num +'</td>' ;
                            cell3.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][limit]" value="' + data.data2[g].me_limit_name  + '" />'+ data.data2[g].me_limit_name+'</td>' ;
                            cell4.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][carpartno]" value="' +  data.data2[g].me_part_num + '" />'+data.data2[g].me_part_num+'</td>' ;
                            cell5.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][carpart]" value="' + data.data2[g].me_part_name + '" />'+data.data2[g].me_part_name+'</td>' ;
                            cell6.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][partcode]" value="' + data.data2[g].me_part_produce_num + '" />'+data.data2[g].me_part_produce_num+'</td>' ;
                            cell7.innerHTML= '<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][parttypeno]" value="' + data.data2[g].me_part_type + '" />'+data.data2[g].me_part_type+'</td>' ;
                            cell8.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][parttype]" value="' + data.data2[g].me_part_typename + '" />'+data.data2[g].me_part_typename+'</td>' ;
                            cell9.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][price]" value="' + data.data2[g].mech_price + '" />'+data.data2[g].mech_price +'</td>' ;

                            cell10.innerHTML= '<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][count]" value="' + data.data2[g].me_mech_count  + '" />'+data.data2[g].me_mech_count+'</td>' ;
                            cell11.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][percentage]" value="' + data.data2[g].me_rate + '" />'+data.data2[g].me_rate+'</td>' ;
                            cell12.innerHTML= '<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][percentageused]" value="' + data.data2[g].me_consump_mech_rate + '" />'+data.data2[g].me_consump_mech_rate+'</td>' ;
                            cell13.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][date]" value="' + data.data2[g].me_date + '" />'+data.data2[g].me_date+'</td>' ;
                            cell14.innerHTML='<td><input type="hidden" name="Mechanicaltable['+ Maintinanceindex +'][note]" value="' + data.data2[g].me_note + '" />'+data.data2[g].me_note+'</td>' ;
                            cell15.innerHTML='<input type="button" class="btn-danger" value="X" id="remCF" />';
