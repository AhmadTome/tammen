<html xmlns="">
<head>
    <title>استعلام على اعمال صيانة</title>
                    ...
                    <form class="form-group" method="post" action="EditMaintinancework" id="maintinanceform">
                        ...
                        <div class="form-group row" dir="rtl">
                            ...
                            <div class="col-sm-8 pull-right">
                                ...
                                <input class="form-control" id="Percantige" type="text"  placeholder="ادخل  الضريبة"   />
                        ...
                        <div class="form-group row" dir="rtl">
                            ...
                            <div class="col-sm-8 pull-right">
                                <textArea type="Bodynote" class="form-control PanelBodyCssInput _details" rows="5" id="details" placeholder="ادخل ملاحظات" ></textArea>
                            </div>
                        </div>
