...
<div class="panel panel-default">
            <div class="panel-heading text-center PanelHeadingCss">ادخال ضرر</div>
            <div class="panel-body PanelBodyCss">

                <div class="container " style="max-width: 1000px ;margin-bottom: -15px">
                    <form class="form-horizontal" method="post" action="storeDamage" >
                        {{ csrf_field() }}
                        <div class="form-group">

                            <div class="col-sm-2"></div>
                            <div class="col-sm-9">
                                <input type="name" class="form-control PanelBodyCssInput" name="IdDamNum" id="IdDamNum" placeholder="ادخل رقم الضرر" required>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-9">
                                <input type="text" class="form-control PanelBodyCssInput" name="hebrow_damName" id="hebrow_damName" placeholder="ادخل الاسم عبري" required>
                            </div>
